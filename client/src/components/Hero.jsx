...
const Hero= () => {
  return (
    ...
    <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>Discover Tour Perfect Gateway Destination</h1>
